...
if __name__ == '__main__':
    ...
    parser.add_argument('--weights', nargs='+', type=str, default='best_recycle.pt', help='model.pt path(s)')
    parser.add_argument('--source', type=str, default='6', help='source')  # file/folder, 0 for webcam
