...
# Main function
def main():
    model_orig_pcd = o3d.io.read_point_cloud("./pcd/bottle_model_2.pcd")
    sample_pcd = o3d.io.read_point_cloud("./scene/bottle_scene_2.ply")  # Any sample point cloud can be given here
