...
import cv2
# 数据集类别名
names = ['bottles']  # class names
# names = ['bottle','can', 'carton', 'cup','paper']  # class names
# yolov5s网络中的三个detect层
target_layers = ['model/18/cv3/act', 'model/21/cv3/act', 'model/24/cv3/act']

# Arguments
parser = argparse.ArgumentParser()
parser.add_argument('--model-path', type=str, default="runs/train/yolov5s_cbam/weights/best.pt", help='Path to the model')
parser.add_argument('--img-path', type=str, default='grad_cam_test/bottle_54_2.jpg', help='input image path')
