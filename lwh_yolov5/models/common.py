...
class Detections:
    ...
    def save(self, labels=True, save_dir='runs/detect/yolo_MobilenetV3', exist_ok=False):
        save_dir = increment_path(save_dir, exist_ok, mkdir=True)  # increment save_dir
        self._run(save=True, labels=labels, save_dir=save_dir)  # save results

    def crop(self, save=True, save_dir='runs/detect/yolo_MobilenetV3', exist_ok=False):
