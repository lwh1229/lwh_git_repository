...
def parse_model(d, ch):  # model_dict, input_channels(3)
    ...
    for i, (f, n, m, args) in enumerate(d['backbone'] + d['head']):  # from, number, module, args
        ...
        if m in {
                ...
                h_sigmoid, h_swish, SELayer, conv_bn_hswish, MobileNetV3, CBRM, Shuffle_Block, EMA, ECA,
        }:
            c1, c2 = ch[f], args[0]
...
if __name__ == '__main__':
    ...
    parser.add_argument('--cfg', type=str, default='../my_models/yolov5s_shuffleNetV2.yaml', help='model.yaml')
