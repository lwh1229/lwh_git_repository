...
main(int argc, char** argv)
{
	...
	icp.setMaxCorrespondenceDistance(10);  // 设置对应点对之间的最大距离（此值对配准结果影响较大）1。
	icp.setEuclideanFitnessEpsilon(0.005);  // 设置收敛条件是均方误差和小于阈值， 停止迭代；0.05
	icp.setMaximumIterations(500);           // 最大迭代次数35
