...
namespace datastream
{
    ...
    std::string filename_dense_src = "../../6d_data/lwh_yolo/model/bottle3_real.pcd";
    std::string filename_dense_tar = "../../6d_data/lwh_yolo/scene/bottle3_scene.pcd";
